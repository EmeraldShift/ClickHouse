...
namespace Setting
{
    ...
    extern const SettingsBool use_minmax_index_part_subsumption;
    extern const SettingsBool use_minmax_index_specialized_evaluator;
...
MergeTreeReaderSettings MergeTreeReaderSettings::createFromContext(const ContextPtr & context)
{
    ...
    result.use_minmax_index_part_subsumption = settings[Setting::use_minmax_index_part_subsumption];
    result.use_minmax_index_specialized_evaluator = settings[Setting::use_minmax_index_specialized_evaluator];
